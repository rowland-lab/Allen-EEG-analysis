...
function S1_VR_trial_preproc_simple(sbjnum,protocolfolder)
dbstop if error
...
for i=1:length(filePattern)
    vrDataFolders{i,1}=([fileparts(vrDataFolder),'\vr\',filePattern(i).name]);
end

% Load VR file
[trialData,vr_chan]= loadVrTrialData_EEG_ftsync(vrDataFolders,eegDataFile,{'DC1' 'DC2'},true,[],'C:\Users\allen\Box Sync\Desktop\Functions\EEG_toolboxes\Matlab\fieldtrip-20200607');
...
save(fullfile(analysisfolder,[sbjnum,'_S1-VRdata_preprocessed_simple']),'preprocessed_vr','sessioninfo');
