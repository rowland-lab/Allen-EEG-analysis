...
function S2_MetricPlot_simple (sbjnum,protocolfolder)
...
importdata = load(fullfile(subjectfolder,'analysis','S1-VR_preproc',[sbjnum,'_S1-VRdata_preprocessed_simple.mat']));
...
save(fullfile(metricsfolder,[sbjnum,'_S2-Metrics_simple']),'trialData','metricdat','s2rejecttrials','movementstart');
close all
end