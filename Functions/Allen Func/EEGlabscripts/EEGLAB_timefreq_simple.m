function EEGLAB_timefreq_simple(subject,protocolfolder)
...
try 
    ...
    load(fullfile(analysisfolder,'preprocsimple.mat'));
catch
...
save(fullfile(analysisfolder,'EEGlab_power_simple'),'eegevents');
