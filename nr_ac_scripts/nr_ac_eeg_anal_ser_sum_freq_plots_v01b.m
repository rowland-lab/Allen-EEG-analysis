function nr_ac_eeg_anal_ser_sum_freq_plots_v01b(grp,freq_band,mean_mean_var,save_figs,save_data)
...
% grp='hc'
% freq_band='beta'
% mean_mean_var='~/nr_data_analysis/data_analyzed/eeg/gen_02/data/hc_mean_mean_beta_all.mat'
% save_figs='no'
% save_data='yes'
    ...
    for j=1:3
        for k=1:size(sbjs_stm,1)
            ...
            eval(['find_freq_plot_sbj',num2str(sbjs_stm(k,:)),'_ch',num2str(elec_stm_ipsi(k)),'_t',num2str(i),'_p',num2str(j),...
                '=find(epochs.epochsWhole.t',num2str(i),'.',phase{j},'.psd.freq<=50);'])
            ...
            eval(['psd_sbj',num2str(sbjs_stm(k,:)),'_ch',num2str(elec_stm_ipsi(k)),'_t',num2str(i),'_p',num2str(j),'_saw',...
                '=epochs.epochsWhole.t',num2str(i),'.',phase{j},'.psd.saw(find_freq_plot_sbj',num2str(sbjs_stm(k,:)),...
            ...
            eval(['psd_sbj',num2str(sbjs_stm(k,:)),'_ch',num2str(elec_stm_ipsi(k)),'_t',num2str(i),'_p',num2str(j),'_frq',...
                '=epochs.epochsWhole.t',num2str(i),'.',phase{j},'.psd.freq(find_freq_plot_sbj',num2str(sbjs_stm(k,:)),...
...
if strcmp(save_figs,'yes')
    saveas(gcf,['~/nr_data_analysis/data_analyzed/eeg/gen_02/figures/gen_02_verc_sum_all_',grp,'_stm_',freq_band,'.fig'],'fig')
end
    ...
    for j=1:3
        for k=1:size(sbjs_non,1)
            ...
            eval(['psd_sbj',num2str(sbjs_non(k,:)),'_ch',num2str(elec_non_ipsi(k)),'_t',num2str(i),'_p',num2str(j),'_saw',...
                '=epochs.epochsWhole.t',num2str(i),'.',phase{j},'.psd.saw(find_freq_plot_sbj',num2str(sbjs_non(k,:)),...
            ...
            eval(['psd_sbj',num2str(sbjs_non(k,:)),'_ch',num2str(elec_non_ipsi(k)),'_t',num2str(i),'_p',num2str(j),'_frq',...
                '=epochs.epochsWhole.t',num2str(i),'.',phase{j},'.psd.freq(find_freq_plot_sbj',num2str(sbjs_non(k,:)),...
...
if strcmp(save_figs,'yes')
    saveas(gcf,['~/nr_data_analysis/data_analyzed/eeg/gen_02/figures/gen_02_verc_sum_all_',grp,'_non_',freq_band,'.fig'],'fig')
end

if strcmp(save_data,'yes')
        save(['~/nr_data_analysis/data_analyzed/eeg/gen_02/data/',grp,'_mean_mean_sum_',freq_band,'_all'] ,['mean_mean_sum_',freq_band,'*']) 
end