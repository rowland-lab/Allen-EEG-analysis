function nr_eeg_anal_04_psd_stats(data,cond)
...
n_sbj=data.cfg.info.n_sbj;
cond=data.cfg.trial_data.t1.cond;
%eval(['data_eeg_anal_',data.cfg.trial_data.t1.cond,'_pro00087153_00',data.cfg.info.n_sbj,'=data;'])
eval(['data_eeg_anal_',cond,'_pro00087153_00',n_sbj,'=data;'])
clear data f* g* i j k l m  s* m*
eval(['save(''data_eeg_anal_',cond,'_pro00087153_00',n_sbj,''')'])
