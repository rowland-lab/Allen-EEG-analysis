function [trialData,VR_chan_auto,tDCS_default,Session_positions] = loadVrTrialData_EEG_03(vrDataFolder,eegDataFile,eegSyncChannels,tDCSchannellabels,manualSyncReview,VR_chan)
