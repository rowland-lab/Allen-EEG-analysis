function output=step_01_nr_ac_eeg_anal_ser_data_vis_03(sbjfolder)
...
load(['/home/rowlandn/nr_data_analysis/data_analyzed/data_for_dlc/',sbjname,...
        '_sessioninfo.mat'])
setdiff_01=setdiff([1:sessioninfo.s1rejecttrials(end)],sessioninfo.s1rejecttrials)

output{1}=sbjname(15:16)
output{2}=setdiff_01
output{3}=size(sessioninfo.trialnames,2)
%load([sbjfolder,'\analysis\S3-EEGanalysis\s3_dat.mat'])
...
%             text(temp_val,0,['epoch ',num2str(j)],'FontSize',11,'Rotation',-90,'FontWeight','bold')
%             text(temp_val,-20,['epoch ',num2str(j)],'FontSize',11,'Rotation',-90,'FontWeight','bold')
%         end
%     end
