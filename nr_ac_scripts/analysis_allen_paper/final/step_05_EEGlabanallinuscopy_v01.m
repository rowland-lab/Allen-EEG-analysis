...
%
%%
%This section just produces the variable 'subjectData.mat'
calc_icoh=true;
calc_kin=true;
calc_labpower=true;
...
%This makes a variable called exportData that you can save if you want
...
%% Linear Regressions
%Note that if you have already run one of the sections above you have to
%clear all and run the import section again
...
[f_p_all_sum_c3_c4_beta_stroke_stim_reac,f_tab_all_sum_c3_c4_beta_stroke_stim_reac,f_stats_all_sum_c3_c4_beta_stroke_stim_reac]=...
    friedman(all_sum_c3_c4_beta_stroke_stim_reac)
