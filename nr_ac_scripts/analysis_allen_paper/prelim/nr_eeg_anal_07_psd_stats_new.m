function nr_eeg_anal_07_psd_stats_new(data_file)
...
figure
set(gcf,'Position',[1750 580 797 899])
...
saveas(gcf,[data.cfg.info.dx,'_',data.cfg.info.stim_stat,'_',...
    data.cfg.info.n_sbj,'_',data.cfg.trial_data.t1.cond,'_03.pdf'])




%save new stats and plots
cd ~/nr_data_analysis/data_analyzed/eeg/
eval([var_name,'.stats_new_7=data.stats_new_7'])
eval([var_name,'.stats_new_18=data.stats_new_18'])
eval([var_name,'.plots_new_7=data.plots_new_7'])
eval([var_name,'.plots_new_18=data.plots_new_18'])
