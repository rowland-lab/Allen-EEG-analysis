...
%             figure; set(gcf,'Position',[1119 25 744 898])
            ...
            for k=1:eval(['size(epochs.vrevents.t',num2str(j),'.',phase{i},'.val,1)'])%12
            ...
            for m=1:eval(['size(epochs.vrevents.t',num2str(j),'.',phase{i},'.val,1)'])%12
                subplot(4,4,sp(m))
            ...
            for n=1:eval(['size(epochs.vrevents.t',num2str(j),'.',phase{i},'.val,1)'])%12
            ...
            if eval(['isempty(out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),')'])==1
                ...
                for k=1:eval(['size(out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),',2)'])
                    eval(['epoch_st_out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),...
                        ...
                        '=epochs.vrevents.t',num2str(j),'.',phase{i},'.val(',num2str(eval(['out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),'(',num2str(k),')'])),',1)'])
                    eval(['epoch_ed_out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),...
                        '_',num2str(eval(['out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),'(',num2str(k),')'])),...
                        '=epochs.vrevents.t',num2str(j),'.',phase{i},'.val(',num2str(eval(['out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),'(',num2str(k),')'])),',2)'])
            ...
            if eval(['isempty(out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),')'])==1
                ...
                for k=1:eval(['size(out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),',2)'])
                    if l==18
                        ...
                        eval(['set(gca,''ylim'',[-25 -16],''xlim'',[epoch_st_out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),...
                                '_',num2str(eval(['out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),'(',num2str(k),')'])),...
                                '-20000 epoch_st_out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),...
                                '_',num2str(eval(['out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),'(',num2str(k),')'])),...
                                '+20000])'])
                    elseif l==7
                         eval(['set(gca,''ylim'',[-6 6],''xlim'',[epoch_st_out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),...
                                '_',num2str(eval(['out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),'(',num2str(k),')'])),...
                                '-20000 epoch_st_out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),...
                                '_',num2str(eval(['out_mean_beta_c',num2str(l),'_t',num2str(j),'_p',num2str(i),'(',num2str(k),')'])),...
                                '+20000])'])
...
%     epoch_ed=epochs.vrevents.t1.atStartPosition.val(11,2)
%     figure
...
%     plot(4.35e6,-8,'go')
%     plot(trialData.eeg.data(epochs.vrevents.t1.atStartPosition.val(11,1):epochs.vrevents.t1.atStartPosition.val(11,2),18),'r')
%     


%[a,b]=find(isoutlier(mean_beta_t2_p1_c18,'quartiles','ThresholdFactor',1.5))
% 
% (epochs.vrevents.t',num2str(j),'.',phase{i},'.val(m,1):epochs.vrevents.t',...
%                     num2str(j),'.',phase{i},'.val(m,2)
%                 for i=[1 2 4 5 8 12]
% eval(['reaches1(',num2str(i),',:)=trialData.eeg.data(epochs.vrevents.t2.atStartPosition.val(',num2str(i),...
%     ',1):epochs.vrevents.t2.atStartPosition.val(',num2str(i),',2),18);'])
%                 end
