function nr_S2_MetricPlot_02(sbjnum,protocolfolder,threshold)
...
for i=1:numel(prestimtrials.num)
    ...
    eval(['[vrMetrics_pre.t',num2str(prestimtrials.num(i)),',rejecttrials.pre{i},movementstart.pre{i}]= nr_calculateVRMetrics(trialData.vr(prestimtrials.num(i)),environmentSettings,fh,string(colorsnr.pre),linestyle{i},1);'])
end
...
for i=1:numel(stimtrials.num)
    ...
    % calculate vr metrics
    if i==1
        eval(['[vrMetrics_stim.t',num2str(stimtrials.num(i)),',rejecttrials.stim{i},movementstart.stim{i}]= nr_calculateVRMetrics(trialData.vr(stimtrials.num(i)),environmentSettings,fh,string(colorsnr.stim),linestyle{i},1);'])
    else
        eval(['[vrMetrics_stim.t',num2str(stimtrials.num(i)),',rejecttrials.stim{i},movementstart.stim{i}]= nr_calculateVRMetrics(trialData.vr(stimtrials.num(i)),environmentSettings,fh,string(colorsnr.stim),linestyle{i},0);'])
    end
end
...
for i=1:numel(poststimtrials.num)
    ...
    % calculate vr metrics
    if i==1
        eval(['[vrMetrics_post.t',num2str(poststimtrials.num(i)),',rejecttrials.post{i},movementstart.post{i}]= nr_calculateVRMetrics(trialData.vr(poststimtrials.num(i)),environmentSettings,fh,string(colorsnr.post),linestyle{i},1);'])
    else
        eval(['[vrMetrics_post.t',num2str(poststimtrials.num(i)),',rejecttrials.post{i},movementstart.post{i}]= nr_calculateVRMetrics(trialData.vr(poststimtrials.num(i)),environmentSettings,fh,string(colorsnr.post),linestyle{i},0);'])
    end
end
%%
figure(fh(1))
...
%% bar graphs
figure; set(gcf,'Position',[36 57 1415 871])
